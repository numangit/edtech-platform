...
const AdminDashboard = () => {
    ...
    const options = [
        ...
        },
        {
            ...
            logo: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
        ...
        },
        {
            ...
            link: "/admin/assignment-mark",
            logo: <svg viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
            ...
            <div class="mx-auto max-w-7xl px-5 lg:px-0">
                <div class="px-3 md:lg:xl:px-40  py-20 bg-opacity-10">
                    <div class="grid grid-cols-1 md:grid-cols-2  gap-6 p-8">
                        {
                            options.map(option =>
                                <Link to={option.link} class="dashboard-item-card">
                                    {option.logo}
                                    <p class="text-slate-200 mt-3 ">{option.name}</p>
                                </Link>
                            )
                        }
                    </div>
